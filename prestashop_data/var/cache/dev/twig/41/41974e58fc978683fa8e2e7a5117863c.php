...
";
    ...
    public function macro_dump_request_data($__token__ = null, $__events__ = null, $__origin__ = null, ...$__varargs__)
    {
        ...
        try {
            ...
            // line 156
            $macros["__internal_parse_27"] = $this;
            // line 157
            echo "{
    id: \"";
            // line 158
    ...
    events: [ ";
            // line 161
            echo twig_call_macro($macros["__internal_parse_27"], "macro_dump_events", [(isset($context["events"]) || array_key_exists("events", $context) ? $context["events"] : (function () { throw new RuntimeError('Variable "events" does not exist.', 161, $this->source); })())], 161, $context, $this->getSourceContext());
            echo " ],
}
";
